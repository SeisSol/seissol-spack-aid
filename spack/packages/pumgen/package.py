...
class Pumgen(CMakePackage):
    ...
    depends_on('mpi')
    # simmetrix (e.g. @2024.0-240616) currently does not have a precompiled libSimPartitionWrapper-openmpi5.a 
    depends_on(f"openmpi@:4", when=f"+with_simmetrix ^[virtuals=mpi] openmpi")
